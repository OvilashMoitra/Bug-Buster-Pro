...
const PurchaseCard = ({ id }: { id: string }) => {
    // !hook
...
// !userInfo
    ...
    const onSubmit:any = async(inputField:{mobileNumber:string}) => {
        // @ts-ignore
        const orderResponse = await addToPurchase({ ...inputField, serviceId: data?.data?.id, customerId: userInfo?.data?._id })
                ...
                <div className="container px-5 py-24 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap flex-col text-white shadow-2xl border-2 border-[rgb(51 56 65)] p-10 rounded-lg">
                        <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                            <h2 className="text-lg title-font text-white tracking-widest">Bug Buster Pro</h2>
