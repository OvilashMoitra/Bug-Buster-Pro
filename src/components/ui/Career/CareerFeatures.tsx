                ...
                <div className="max-w-2xl mx-auto">
                    ...
                    <div className="grid gap-12">
                        ...
                        <div className="space-y-6 lg:space-y-10">
                            {/* <!-- Icon Block --> */}
                            <div className="flex">
                                <svg className="flex-shrink-0 mt-2 h-6 w-6 text-gray-800 dark:text-white" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                            ...
                            <div className="flex">
                                ...
                                <div className="ml-5 sm:ml-8">
                                    ...
                                    <p className="mt-1 text-gray-600 dark:text-gray-400">
                                        We worry about the details so that our residents do not have to. From our online application process to simple, all-inclusive billing we aim to make the living experience as effortless as possible.
                                    </p>
                                </div>
                            </div>
                            {/* <!-- End Icon Block --> */}
